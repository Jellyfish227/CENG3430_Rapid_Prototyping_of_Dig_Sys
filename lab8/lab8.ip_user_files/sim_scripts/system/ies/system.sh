...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../lab8.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
       +incdir+"$ref_dir/../../../../lab8.srcs/sources_1/bd/system/ipshared/2527/hdl" \
       +incdir+"../../../../lab8.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
       +incdir+"../../../../lab8.srcs/sources_1/bd/system/ipshared/2527/hdl" \
