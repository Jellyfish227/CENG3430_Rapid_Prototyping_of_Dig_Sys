...
# set_property PACKAGE_PIN V15 [get_ports {state[1]}];
# set_property IOSTANDARD LVCMOS33 [get_ports {state[0]}];
# set_property PACKAGE_PIN W15 [get_ports {state[0]}];

set_property IOSTANDARD LVCMOS33 [get_ports {din[0]}];
set_property PACKAGE_PIN G15 [get_ports {din[0]}];
set_property IOSTANDARD LVCMOS33 [get_ports {din[1]}];
set_property PACKAGE_PIN P15 [get_ports {din[1]}];
set_property IOSTANDARD LVCMOS33 [get_ports {din[2]}];
set_property PACKAGE_PIN W13 [get_ports {din[2]}];
